<?php
// public/instructors/lessons.php
...
// ----- Filters (scope: upcoming | past | all) -----
...
} // 'all' leaves $whereTime empty

// ----- Query lessons assigned to this instructor -----
$sql = "
  SELECT 
    l.id,
    l.start_time,
